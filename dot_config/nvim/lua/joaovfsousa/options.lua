...
local options = {
  ...
  previewheight = 30,
  listchars = {
    space = "•", -- Displays normal spaces as middle dots
    tab = "» ", -- Displays tabs as angle brackets
    trail = "·", -- Displays trailing spaces as bullets
    eol = "↲", -- Displays end-of-line / newlines
    nbsp = "␣", -- Displays non-breaking spaces
  },
}
